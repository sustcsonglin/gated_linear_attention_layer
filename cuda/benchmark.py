...
Q = torch.randn(batch, num_head, num_chunk, chunk_size, d_head_k, device='cuda', dtype=torch.float32).requires_grad_(True)

K = torch.randn(batch, num_head, num_chunk, chunk_size, d_head_k, device='cuda', dtype=torch.float32).requires_grad_(True)

V = torch.randn(batch, num_head, num_chunk, chunk_size, d_head_v, device='cuda', dtype=torch.float32).requires_grad_(True)
