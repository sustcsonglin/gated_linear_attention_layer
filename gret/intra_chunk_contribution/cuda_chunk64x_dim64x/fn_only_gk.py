...
cuda_compute_inner_chunk64x_d64x = load(
...
class CUDA_inner(torch.autograd.Function):
    ...
    def forward(ctx, q, k, gk):
        ...
        qk = cuda_compute_inner_chunk64x_d64x.forward(q, k, gk)
    ...
    def backward(ctx, dqk):
        ...
        dq, dk, dgk = cuda_compute_inner_chunk64x_d64x.backward(q, k, gk, dqk)
