...
def inter_chunk_onc(query, key, value, gk, gv, normalizer_gk=16, normalizer_gv=16, clam_min=-3):
    ...
    g_key_cumsum, g_value_cumsum, reduce_key, reduce_value, q_exp, g_value_cumsum_exp, g_key_last_exp, g_value_last_exp = PreprocessCumSum.apply(query, key, value, gk, gv, normalizer_gk, normalizer_gv, clam_min)
